...
```
cd existing_repo
git remote add origin https://gitlab.com/i3668/full-stack-team/fraud-detection-api.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/i3668/full-stack-team/fraud-detection-api/-/settings/integrations)
